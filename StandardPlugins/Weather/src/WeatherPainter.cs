	...
	public class WeatherPainter : AbstractDockPainter
	{
		...
		void DrawForecast (Cairo.Context cr)
		{
			...
			for (int day = 0; day < WeatherController.Weather.ForecastDays; day++)
			{
				...
				cr.MoveTo (xOffset + (Allocation.Height - inkRect.Width) / 2, Allocation.Height * 2 / 9 - logicalRect.Height / 2);
				...
				layout.GetPixelExtents (out inkRect, out logicalRect);
				cr.MoveTo (xOffset + (Allocation.Height - inkRect.Width) / 2, Allocation.Height * 5 / 9 - logicalRect.Height / 2);
				Pango.CairoHelper.LayoutPath (cr, layout);
				cr.Fill ();
				...
				layout.GetPixelExtents (out inkRect, out logicalRect);
				cr.MoveTo (xOffset + (Allocation.Height - inkRect.Width) / 2, Allocation.Height * 8 / 9 - logicalRect.Height / 2);
				Pango.CairoHelper.LayoutPath (cr, layout);
				cr.Fill ();
