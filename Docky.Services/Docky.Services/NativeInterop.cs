...
namespace Docky.Services
{
	...
	{		
		...
		static readonly string GIO_NOT_FOUND = Catalog.GetString ("Could not find gio-2.0, please report immediately.");
		static readonly string GOBJECT_NOT_FOUND = Catalog.GetString ("Could not find gobject-2.0, please report immediately.");
		static readonly string GTK_NOT_FOUND = Catalog.GetString ("Could not find gtk-2.0, please report immediately.");
