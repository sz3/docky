...
namespace Docky
{
	public partial class ConfigurationWindow
	{
		...
		protected virtual void Build ()
		{
			...
			this.start_with_computer_checkbutton.Label = global::Mono.Unix.Catalog.GetString ("_Start When Computer Starts");
			...
			global::Gtk.Box.BoxChild w9 = ((global::Gtk.Box.BoxChild)(this.vbox6[this.frame3]));
			w9.Position = 1;
			...
			global::Gtk.Box.BoxChild w13 = ((global::Gtk.Box.BoxChild)(this.hbox1[this.docklet_show_cmb]));
			w13.Position = 0;
			w13.Expand = false;
			w13.Fill = false;
			this.vbox7.Add (this.hbox1);
			global::Gtk.Box.BoxChild w14 = ((global::Gtk.Box.BoxChild)(this.vbox7[this.hbox1]));
			w14.Position = 0;
			w14.Expand = false;
			w14.Fill = false;
			// Container child vbox7.Gtk.Box+BoxChild
			...
			this.docklet_scroll.ShadowType = ((global::Gtk.ShadowType)(1));
			this.vbox7.Add (this.docklet_scroll);
			global::Gtk.Box.BoxChild w15 = ((global::Gtk.Box.BoxChild)(this.vbox7[this.docklet_scroll]));
			w15.Position = 1;
			this.alignment2.Add (this.vbox7);
			this.config_notebook.Add (this.alignment2);
			global::Gtk.Notebook.NotebookChild w17 = ((global::Gtk.Notebook.NotebookChild)(this.config_notebook[this.alignment2]));
			w17.Position = 1;
			// Notebook tab
			...
			global::Gtk.Box.BoxChild w18 = ((global::Gtk.Box.BoxChild)(this.hbox5[this.helper_show_cmb]));
			w18.Position = 0;
			w18.Expand = false;
			w18.Fill = false;
			// Container child hbox5.Gtk.Box+BoxChild
			...
			w21.Pixbuf = global::Stetic.IconLoader.LoadIcon (this, "gtk-execute", global::Gtk.IconSize.Menu);
			w20.Add (w21);
			// Container child GtkHBox.Gtk.Container+ContainerChild
			global::Gtk.Label w23 = new global::Gtk.Label ();
			w23.LabelProp = global::Mono.Unix.Catalog.GetString ("_Install");
			w23.UseUnderline = true;
			w20.Add (w23);
			w19.Add (w20);
			this.install_btn.Add (w19);
			this.hbox5.Add (this.install_btn);
			global::Gtk.Box.BoxChild w27 = ((global::Gtk.Box.BoxChild)(this.hbox5[this.install_btn]));
			w27.PackType = ((global::Gtk.PackType)(1));
			w27.Position = 2;
			w27.Expand = false;
			w27.Fill = false;
			this.vbox5.Add (this.hbox5);
			global::Gtk.Box.BoxChild w28 = ((global::Gtk.Box.BoxChild)(this.vbox5[this.hbox5]));
			w28.Position = 0;
			w28.Expand = false;
			w28.Fill = false;
			// Container child vbox5.Gtk.Box+BoxChild
			...
			this.helper_scroll.ShadowType = ((global::Gtk.ShadowType)(1));
			this.vbox5.Add (this.helper_scroll);
			global::Gtk.Box.BoxChild w29 = ((global::Gtk.Box.BoxChild)(this.vbox5[this.helper_scroll]));
			w29.Position = 1;
			this.alignment3.Add (this.vbox5);
			this.config_notebook.Add (this.alignment3);
			global::Gtk.Notebook.NotebookChild w31 = ((global::Gtk.Notebook.NotebookChild)(this.config_notebook[this.alignment3]));
			w31.Position = 2;
			// Notebook tab
			...
			global::Gtk.Box.BoxChild w32 = ((global::Gtk.Box.BoxChild)(this.vbox1[this.config_notebook]));
			w32.Position = 0;
			// Container child vbox1.Gtk.Box+BoxChild
			...
			w37.LabelProp = global::Mono.Unix.Catalog.GetString ("_New Dock");
			w37.UseUnderline = true;
			w34.Add (w37);
			w33.Add (w34);
			this.new_dock_button.Add (w33);
			this.hbox3.Add (this.new_dock_button);
			global::Gtk.Box.BoxChild w41 = ((global::Gtk.Box.BoxChild)(this.hbox3[this.new_dock_button]));
			w41.Position = 0;
			w41.Expand = false;
			w41.Fill = false;
			// Container child hbox3.Gtk.Box+BoxChild
			...
			w46.LabelProp = global::Mono.Unix.Catalog.GetString ("_Delete Dock");
			w46.UseUnderline = true;
			w43.Add (w46);
			w42.Add (w43);
			this.delete_dock_button.Add (w42);
			this.hbox3.Add (this.delete_dock_button);
			global::Gtk.Box.BoxChild w50 = ((global::Gtk.Box.BoxChild)(this.hbox3[this.delete_dock_button]));
			w50.Position = 1;
			w50.Expand = false;
			w50.Fill = false;
			// Container child hbox3.Gtk.Box+BoxChild
			...
			global::Gtk.Box.BoxChild w52 = ((global::Gtk.Box.BoxChild)(this.hbox3[this.close_button]));
			w52.Position = 3;
			w52.Expand = false;
			w52.Fill = false;
			this.hbox2.Add (this.hbox3);
			global::Gtk.Box.BoxChild w53 = ((global::Gtk.Box.BoxChild)(this.hbox2[this.hbox3]));
			w53.Position = 0;
